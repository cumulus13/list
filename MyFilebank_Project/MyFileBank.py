...
class MainApp(QtGui.QMainWindow):
    def __init__(self, parent=None):
        ...
        self.progress.setGeometry(20, 627, 380, 20)
        ...
        self.Gbox1.setGeometry(20, 20, 470, 300)
        ...
        self.Gbox2.setGeometry(500, 20, 380, 100)
        ...
        self.Gbox3.setGeometry(500, 120, 380, 100)
        self.Gbox3.setToolTip('Search File')
        self.Gbox3.setStatusTip('Search File')
        
        #Group For Code File 
        self.Gbox6 = QtGui.QGroupBox(self)
        self.Gbox6.setTitle('Code ')
        self.Gbox6.setGeometry(500, 220, 380, 100)
        self.Gbox6.setToolTip('Code File')
        self.Gbox6.setStatusTip('Code File')
        
        self.codename = QtGui.QLabel(self.Gbox6)
        self.codename.setFont(QtGui.QFont("Arial", 70, 600))
        self.codename.setGeometry(10, 20, 380, 70)
        self.codename.setText('')
        ...
        self.pagesWidget.setGeometry(818, 1, 80, 24)
        self.pagesWidget.addWidget(DClock.DigitalClock())
        ...
        self.connect(self.RB_winfile, QtCore.SIGNAL("clicked()"), self.versearch)
        ...
        self.connect(self.RB_linfile, QtCore.SIGNAL("clicked()"), self.versearch)
        ...
        self.connect(self.RB_winmaster, QtCore.SIGNAL("clicked()"), self.versearch)
        ...
        self.connect(self.RB_linmaster, QtCore.SIGNAL("clicked()"), self.versearch)
        ...
        self.connect(self.RB_music, QtCore.SIGNAL("clicked()"), self.versearch)
        ...
        self.connect(self.RB_driverstudio, QtCore.SIGNAL("clicked()"), self.versearch)
        ...
        self.connect(self.RB_ebookfile, QtCore.SIGNAL("clicked()"), self.versearch)
        ...
        self.connect(self.RB_netsoft, QtCore.SIGNAL("clicked()"), self.versearch)
        ...
        self.RB_hddbck.setGeometry(10, 180, 120, 20)
        ...
        self.connect(self.RB_hddbck, QtCore.SIGNAL("clicked()"), self.versearch)
        ...
        self.RB_hackersoft.setGeometry(10, 200, 120, 20)
        ...
        self.connect(self.RB_hackersoft, QtCore.SIGNAL("clicked()"), self.versearch)
        ...
        self.RB_gamesoft.setGeometry(10, 220, 120, 20)
        ...
        self.connect(self.RB_gamesoft, QtCore.SIGNAL("clicked()"), self.versearch)
        ...
        self.RB_bootsoft.setGeometry(10, 240, 120, 20)
        ...
        self.connect(self.RB_bootsoft, QtCore.SIGNAL("clicked()"), self.versearch)
        ...
        self.RB_databck.setGeometry(10, 260, 120, 20)
        ...
        self.connect(self.RB_databck, QtCore.SIGNAL("clicked()"), self.versearch)
        ...
        self.RB_tutorial = QtGui.QRadioButton(self.Gbox1)
        self.RB_tutorial.setText('Tutorial')
        #self.RB_gamesoft.setGeometry(140, 60, 120, 20)
        self.RB_tutorial.setGeometry(140, 20, 120, 20)
        self.RB_tutorial.setToolTip('Tutorial')
        self.RB_tutorial.setStatusTip('Tutorial')
        self.connect(self.RB_tutorial, QtCore.SIGNAL("clicked()"), self.datatutorial)
        self.connect(self.RB_tutorial, QtCore.SIGNAL("clicked()"), self.versearch)
        self.connect(self.RB_tutorial, QtCore.SIGNAL("clicked()"), self.clearlistree)
        self.connect(self.RB_tutorial, QtCore.SIGNAL("clicked()"), self.addinfo3clear)
        self.connect(self.RB_tutorial, QtCore.SIGNAL("clicked()"), self.totalsizeclear)

        self.RB_film = QtGui.QRadioButton(self.Gbox1)
        self.RB_film.setText('Film')
        #self.RB_gamesoft.setGeometry(140, 60, 120, 20)
        self.RB_film.setGeometry(140, 40, 120, 20)
        self.RB_film.setToolTip('Film')
        self.RB_film.setStatusTip('Film')
        self.connect(self.RB_film, QtCore.SIGNAL("clicked()"), self.datafilm)
        self.connect(self.RB_film, QtCore.SIGNAL("clicked()"), self.versearch)
        self.connect(self.RB_film, QtCore.SIGNAL("clicked()"), self.clearlistree)
        self.connect(self.RB_film, QtCore.SIGNAL("clicked()"), self.addinfo3clear)
        self.connect(self.RB_film, QtCore.SIGNAL("clicked()"), self.totalsizeclear)

        self.RB_winmasterold = QtGui.QRadioButton(self.Gbox1)
        self.RB_winmasterold.setText('Windows Old')
        #self.RB_gamesoft.setGeometry(140, 60, 120, 20)
        self.RB_winmasterold.setGeometry(140, 60, 120, 20)
        self.RB_winmasterold.setToolTip('Windows Old')
        self.RB_winmasterold.setStatusTip('Windows Old')
        self.connect(self.RB_winmasterold, QtCore.SIGNAL("clicked()"), self.datawinmasterold)
        self.connect(self.RB_winmasterold, QtCore.SIGNAL("clicked()"), self.versearch)
        self.connect(self.RB_winmasterold, QtCore.SIGNAL("clicked()"), self.clearlistree)
        self.connect(self.RB_winmasterold, QtCore.SIGNAL("clicked()"), self.addinfo3clear)
        self.connect(self.RB_winmasterold, QtCore.SIGNAL("clicked()"), self.totalsizeclear)

        #self.RB_tora = QtGui.QRadioButton(self.Gbox1)
        #self.RB_tora.setText('Tora')
        #self.RB_gamesoft.setGeometry(140, 60, 120, 20)
        #self.RB_tora.setGeometry(140, 80, 120, 20)
        #self.RB_tora.setToolTip('Tora')
        #self.RB_tora.setStatusTip('Tora')
        #self.connect(self.RB_tora, QtCore.SIGNAL("clicked()"), self.datatora)
        #self.connect(self.RB_tora, QtCore.SIGNAL("clicked()"), self.versearch)
        #self.connect(self.RB_tora, QtCore.SIGNAL("clicked()"), self.clearlistree)
        #self.connect(self.RB_tora, QtCore.SIGNAL("clicked()"), self.addinfo3clear)
        #self.connect(self.RB_tora, QtCore.SIGNAL("clicked()"), self.totalsizeclear)

        self.RB_datadrive = QtGui.QRadioButton(self.Gbox1)
        self.RB_datadrive.setText('Data Drive')
        self.RB_datadrive.setGeometry(140, 80, 120, 20)
...
#******************************************************************************************************************	
        ...
        self.combofile.setGeometry(100, 15, 270, 20)
        ...
        self.combolabeladdinfo2.setGeometry(100, 40, 270, 20)
        ...
        self.combofilebt.setGeometry(300, 65, 70, 30)
        ...
        self.connect(self.searchbt, QtCore.SIGNAL("clicked()"), self.searchx)
        ...
        self.wrk.setGeometry(20, 345, 860, 280)
        ...
        self.result.setGeometry(0, 0, 860, 280)
...
#******************************************************************************************************************
    ...
    def datafilm(self):
        ...
        if self.combofilelist.isChecked() + self.RB_film.isChecked():
            self.connect(self.combofilelist, QtCore.SIGNAL("clicked()"), self.datafilmlist)
        if self.combofiletree.isChecked() + self.RB_film.isChecked():
            self.connect(self.combofiletree, QtCore.SIGNAL("clicked()"), self.datafilmtree)

    def datatutorial(self):
        self.combofilelist.show()
        self.combofiletree.show()
        self.combofile.clear()
        self.combofilelist.clearFocus()
        ...
        if self.combofilelist.isChecked() + self.RB_tutorial.isChecked():
            self.connect(self.combofilelist, QtCore.SIGNAL("clicked()"), self.datatutoriallist)
        if self.combofiletree.isChecked() + self.RB_tutorial.isChecked():
            self.connect(self.combofiletree, QtCore.SIGNAL("clicked()"), self.datatutorialtree)

    def datawinmasterold(self):
        self.combofilelist.show()
        self.combofiletree.show()
        self.combofile.clear()
        self.combofilelist.clearFocus()
        ...
        if self.combofilelist.isChecked() + self.RB_winmasterold.isChecked():
            self.connect(self.combofilelist, QtCore.SIGNAL("clicked()"), self.datawinmasteroldlist)
        if self.combofiletree.isChecked() + self.RB_winmasterold.isChecked():
            self.connect(self.combofiletree, QtCore.SIGNAL("clicked()"), self.datawinmasteroldtree)
    ...
    def datatora(self):
        ...
        if self.combofilelist.isChecked() + self.RB_tora.isChecked():
            self.connect(self.combofilelist, QtCore.SIGNAL("clicked()"), self.datatoralist)
        if self.combofiletree.isChecked() + self.RB_tora.isChecked():
            self.connect(self.combofiletree, QtCore.SIGNAL("clicked()"), self.datatoratree)

##################################################################################################################################################################
    def filelist(self, data01, data02):
        self.combofile.clear()
        self.resultlabelout.setText("")
        self.addinfo2
        if self.RB_winfile.isChecked() and self.combofilelist.isChecked():
            self.addinfo2
            datanumlist =  os.popen(data01).readlines( )
            dataxnumlist =  datanumlist[-2].split(" File(s)")
            dataznumlist =  dataxnumlist[0].split(" ")
            x = int(dataznumlist[-1])
            print x
            #print dataz[-1]
            datalist = os.popen(data02).readlines( )
    ...
    def windowfilelist(self):
        data001 = 'dir /d e:\CD_DVD_LIST\P*list*'
        data002 = 'dir /b e:\CD_DVD_LIST\P*list*'
        self.filelist(data001, data002)


    def windowfiletree(self):
        data001 = 'dir /d e:\CD_DVD_LIST\P*tree*'
        data002 = 'dir /b e:\CD_DVD_LIST\P*tree*'
        self.filetree(data001, data002)


    def linuxfilelist(self):
        data01 = 'dir /d e:\CD_DVD_LIST\L0*list*'
        data02 = 'dir /b e:\CD_DVD_LIST\L0*list*'
        self.combofile.clear()
        self.resultlabelout.setText("")
    ...
    def windowMfilelist(self):
        ...
        if self.RB_winmaster.isChecked() and self.combofilelist.isChecked():
            datanumlist =  os.popen('dir /d e:\CD_DVD_LIST\W0*list*').readlines( )
            dataxnumlist =  datanumlist[-2].split(" File(s)")
            dataznumlist =  dataxnumlist[0].split(" ")
            x = int(dataznumlist[-1])
            print x
            #print dataz[-1]
            datalist = os.popen('dir /b e:\CD_DVD_LIST\W0*list*').readlines( )
    ...
    def windowMfiletree(self):
        ...
        if self.RB_winmaster.isChecked() and self.combofiletree.isChecked():
            datanumtree =  os.popen('dir /d e:\CD_DVD_LIST\W0*tree*').readlines( )
            dataxnumtree =  datanumtree[-2].split(" File(s)")
            dataznumtree =  dataxnumtree[0].split(" ")
            x = int(dataznumtree[-1])
            print x
            #print dataz[-1]
            datatree = os.popen('dir /b e:\CD_DVD_LIST\W0*tree*').readlines( )
    ...
    def datatutoriallist(self):
        self.combofile.clear()
        self.resultlabelout.setText("")
        if self.RB_tutorial.isChecked() and self.combofilelist.isChecked():
            datanumlist =  os.popen('dir /d e:\CD_DVD_LIST\T0*list*').readlines( )
            dataxnumlist =  datanumlist[-2].split(" File(s)")
            dataznumlist =  dataxnumlist[0].split(" ")
            x = int(dataznumlist[-1])
            print x
            #print dataz[-1]
            datalist = os.popen('dir /b e:\CD_DVD_LIST\T0*list*').readlines( )
    ...
    def datatutorialtree(self):
        self.combofile.clear()
        self.resultlabelout.setText("")
        if self.RB_tutorial.isChecked() and self.combofiletree.isChecked():
            datanumtree =  os.popen('dir /d e:\CD_DVD_LIST\T0*tree*').readlines( )
            dataxnumtree =  datanumtree[-2].split(" File(s)")
            dataznumtree =  dataxnumtree[0].split(" ")
            x = int(dataznumtree[-1])
            print x
            #print dataz[-1]
            datatree = os.popen('dir /b e:\CD_DVD_LIST\T0*tree*').readlines( )
    ...
    def datafilmlist(self):
        self.combofile.clear()
        self.resultlabelout.setText("")
        if self.RB_film.isChecked() and self.combofilelist.isChecked():
            datanumlist =  os.popen('dir /d e:\CD_DVD_LIST\F*list*').readlines( )
            dataxnumlist =  datanumlist[-2].split(" File(s)")
            dataznumlist =  dataxnumlist[0].split(" ")
            x = int(dataznumlist[-1])
            print x
            #print dataz[-1]
            datalist = os.popen('dir /b e:\CD_DVD_LIST\F*list*').readlines( )
    ...
    def datafilmtree(self):
        self.combofile.clear()
        self.resultlabelout.setText("")
        if self.RB_film.isChecked() and self.combofiletree.isChecked():
            datanumtree =  os.popen('dir /d e:\CD_DVD_LIST\F*tree*').readlines( )
            dataxnumtree =  datanumtree[-2].split(" File(s)")
            dataznumtree =  dataxnumtree[0].split(" ")
            x = int(dataznumtree[-1])
            print x
            #print dataz[-1]
            datatree = os.popen('dir /b e:\CD_DVD_LIST\F*tree*').readlines( )
    ...
    def datawinmasteroldlist(self):
        self.combofile.clear()
        self.resultlabelout.setText("")
        if self.RB_winmasterold.isChecked() and self.combofilelist.isChecked():
            datanumlist =  os.popen('dir /d e:\CD_DVD_LIST\WD*list*').readlines( )
            dataxnumlist =  datanumlist[-2].split(" File(s)")
            dataznumlist =  dataxnumlist[0].split(" ")
            x = int(dataznumlist[-1])
            print x
            #print dataz[-1]
            datalist = os.popen('dir /b e:\CD_DVD_LIST\WD*list*').readlines( )
    ...
    def datawinmasteroldtree(self):
        self.combofile.clear()
        self.resultlabelout.setText("")
        if self.RB_winmasterold.isChecked() and self.combofiletree.isChecked():
            datanumtree =  os.popen('dir /d e:\CD_DVD_LIST\WD*tree*').readlines( )
            dataxnumtree =  datanumtree[-2].split(" File(s)")
            dataznumtree =  dataxnumtree[0].split(" ")
            x = int(dataznumtree[-1])
            print x
            #print dataz[-1]
            datatree = os.popen('dir /b e:\CD_DVD_LIST\WD*tree*').readlines( )
    ...
    def datatoralist(self):
        self.combofile.clear()
        self.resultlabelout.setText("")
        if self.RB_tora.isChecked() and self.combofilelist.isChecked():
            datanumlist =  os.popen('dir /d e:\CD_DVD_LIST\TR*list*').readlines( )
            dataxnumlist =  datanumlist[-2].split(" File(s)")
            dataznumlist =  dataxnumlist[0].split(" ")
            x = int(dataznumlist[-1])
            print x
            #print dataz[-1]
            datalist = os.popen('dir /b e:\CD_DVD_LIST\TR*list*').readlines( )
    ...
    def datatoratree(self):
        self.combofile.clear()
        self.resultlabelout.setText("")
        if self.RB_tora.isChecked() and self.combofiletree.isChecked():
            datanumtree =  os.popen('dir /d e:\CD_DVD_LIST\TR*tree*').readlines( )
            dataxnumtree =  datanumtree[-2].split(" File(s)")
            dataznumtree =  dataxnumtree[0].split(" ")
            x = int(dataznumtree[-1])
            print x
            #print dataz[-1]
            datatree = os.popen('dir /b e:\CD_DVD_LIST\TR*tree*').readlines( )
...
#-----------------------------------------------------------------------------------------------------------------------
    ...
    def addinfo3(self):
        try:
            if self.combofile.currentIndex != "":
                ...
                self.codename.setText(str(datacodexx[0]))
                #print "testMe1 :", datainfox, "\n\n"
                #print "testMe2 :", datainfox4, "\n\n"
                #print "datainfo :", datainfox4[-1]
    ...
    #def searchx(self, datafile):
    #    try:
    #	    datafile = self.combofile.currentText()
    #	    if (len(datafile) < 1):
    #		self.result.setText("No File Refinition !")
    #		
    #	    else:		
    ...
    #		print "data = ", data, "\n"
        ...
        #	i = self.searchtext.currentText()
        #	for x in range(0, lendata):
        #	    if i in data[x]:
        #		print "\n"
        #		datax01 =  "\t Line : " + str(x) + ". " + data[x]
        #		self.result.setText(datax01)
        #	    else:
        #		os.system("cls")
        #		print "\n\n"
        #		datax02 = "\t Masukkan Nama File yang benar ! \n"
        #		self.result.setText(datax02)
    ...
    def searchallfile(self):

        if (self.RB_winfile.isChecked()):

            self.RB_linfile.setChecked(False)
            self.RB_winmaster.setChecked(False)
            self.RB_linmaster.setChecked(False)
            self.RB_music.setChecked(False)
            self.RB_driverstudio.setChecked(False)
            self.RB_ebookfile.setChecked(False)
            self.RB_netsoft.setChecked(False)
            self.RB_hddbck.setChecked(False)
            self.RB_hackersoft.setChecked(False)
            self.RB_gamesoft.setChecked(False)
            self.RB_bootsoft.setChecked(False)	
            self.RB_databck.setChecked(False)
            self.RB_databck.setChecked(False)
            self.RB_datadrive.setChecked(False)

            dataver02 = open("e:\CD_DVD_LIST\\dataver.dat", "r").read()

            if (self.combofilelist.isChecked()):

                self.combofiletree.setChecked(False)

                dataid = os.popen("dir /b e:\CD_DVD_LIST\\" + dataver02 + "*list*").readlines()
                print "dataid = ", dataid, "\n"
                ...
                dataid = os.popen("dir /b e:\CD_DVD_LIST\\" + dataver02 + "*tree*").readlines()
                print dataid, "\n"
                print "Len dataid = ", len(dataid)
    ...
    def searchx(self):
        try:
            if self.RB_currentFile.isChecked():

                self.RB_allFile.setChecked(False)
                ...
                if (len(datafile) < 1):
                    ...
                    data = open("e:\CD_DVD_LIST\\" + datafile).readlines()
                    print "data = ", data, "\n"
                    lendata = len(data)
                    print "lendata = ", lendata, "\n"
                    i = self.search.currentText()
                    print "i = ", i
                    if (os.path.isfile('e:\CD_DVD_LIST\\zresult.dat') == True):
                        os.remove('e:\CD_DVD_LIST\\zresult.dat')
                        dataresult01 = open("e:\CD_DVD_LIST\\zresult.dat", "w")
                        dataresult01.close()
                        for x in range(0, lendata):
                            #print "x = ", x
                            ...
                            if str(i) in data[x]:
                                #print "\n"
                                datax01 =  "\n Line : " + str(x) + ". " + data[x]
                                dataresult02 = open("e:\CD_DVD_LIST\\zresult.dat", "a").write(datax01)
                                dataresult03 = open("e:\CD_DVD_LIST\\zresult.dat", "r").read()
                                self.result.setText(dataresult03)
                                print datax01
                            self.progress.show()
                            self.progress.setRange(0, lendata)
            ...
            elif (self.RB_allFile.isChecked):
                self.searchallfile()
                self.RB_currentFile.setChecked(False)
    ...
    def versearch(self):
        if(self.RB_winfile.isChecked()):
            datast = "P"
            dataver01 = open("e:\CD_DVD_LIST\\dataver.dat", "w").write(str(datast))
        elif(self.RB_linfile.isChecked()):
            datast = "L"
            dataver01 = open("e:\CD_DVD_LIST\\dataver.dat", "w").write(str(datast))
        elif(self.RB_winmaster.isChecked()):
            datast = "W"
            dataver01 = open("e:\CD_DVD_LIST\\dataver.dat", "w").write(str(datast))
        elif(self.RB_linmaster.isChecked()):
            datast = "LM"
            dataver01 = open("e:\CD_DVD_LIST\\dataver.dat", "w").write(str(datast))
        elif(self.RB_music.isChecked()):
            datast = "M"
            dataver01 = open("e:\CD_DVD_LIST\\dataver.dat", "w").write(str(datast))
        elif(self.RB_drivelist.isChecked()):
            datast = "D"
            dataver01 = open("e:\CD_DVD_LIST\\dataver.dat", "w").write(str(datast))
        elif(self.RB_ebookfile.isChecked()):
            datast = "E"
            dataver01 = open("e:\CD_DVD_LIST\\dataver.dat", "w").write(str(datast))
        elif(self.RB_netsoft.isChecked()):
            datast = "N"
            dataver01 = open("e:\CD_DVD_LIST\\dataver.dat", "w").write(str(datast))
        elif(self.RB_hddbck.isChecked()):
            datast = "HD"
            dataver01 = open("e:\CD_DVD_LIST\\dataver.dat", "w").write(str(datast))
        elif(self.RB_hackersoft.isChecked()):
            datast = "HCK"
            dataver01 = open("e:\CD_DVD_LIST\\dataver.dat", "w").write(str(datast))
        elif(self.RB_gamesoft.isChecked()):
            datast = "G"
            dataver01 = open("e:\CD_DVD_LIST\\dataver.dat", "w").write(str(datast))
        elif(self.RB_bootsoft.isChecked()):
            datast = "B"
            dataver01 = open("e:\CD_DVD_LIST\\dataver.dat", "w").write(str(datast))
        elif(self.RB_databck.isChecked()):
            datast = "BCK"
            dataver01 = open("e:\CD_DVD_LIST\\dataver.dat", "w").write(str(datast))
        elif(self.RB_tutorial.isChecked()):
            datast = "T0"
            dataver01 = open("e:\CD_DVD_LIST\\dataver.dat", "w").write(str(datast))
        elif(self.RB_film.isChecked()):
            datast = "F"
            dataver01 = open("e:\CD_DVD_LIST\\dataver.dat", "w").write(str(datast))
        elif(self.RB_winmasterold.isChecked()):
            datast = "WD"
            dataver01 = open("e:\CD_DVD_LIST\\dataver.dat", "w").write(str(datast))
        elif(self.RB_tora.isChecked()):
            datast = "TR"
            dataver01 = open("e:\CD_DVD_LIST\\dataver.dat", "w").write(str(datast))
